...
public final class StepSpec {
    ...
    private Anchor after = Anchor.COMPILE;
    private Anchor before = Anchor.PACKAGE;
    ...
    public StepSpec after(Anchor anchor) {
        this.after = anchor;
        return this;
    }

    public StepSpec before(Anchor anchor) {
        this.before = anchor;
        return this;
    }
    ...
    public Anchor afterAnchor() {
        return after;
    }

    public Anchor beforeAnchor() {
        return before;
    }
