 ...
 * display, or the multi-line goal view — that owns part of the screen between "show" and "close".
 *
...
public interface LiveRegion {
     ...
     * ‼ }). Defaults to the generic notice; the goal/simple view overrides it to name the goal
