...
/**
 * Static help-content data shared across the help renderers: the top-level verb groupings, the
...
public final class UsageGroups {
    ...
    /**
     * Top-level verb groupings for --help. Order within each group is rough lifecycle / workflow
    ...
    /**
     * Curated subset of verbs shown when the user runs bare {@code jk}. Goal: cover the day-to-day
     * verbs without overwhelming first-time users. The full screen is still one keystroke away via
     * {@code --help}.
     */
