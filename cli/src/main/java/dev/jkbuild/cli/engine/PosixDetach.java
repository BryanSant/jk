 ...
 *
 * <p>The downcall descriptor is registered for native-image at build time by {@code
 * EngineDetachFeature}.
 */
public final class PosixDetach {
    ...
    /**
     * {@code pid_t setsid(void)} — {@code pid_t} is a 32-bit int on Linux and macOS. Public only
     * so {@code EngineDetachFeature} (different package) can register the identical descriptor at
     * image-build time.
     */
    public static final FunctionDescriptor SETSID = FunctionDescriptor.of(ValueLayout.JAVA_INT);
