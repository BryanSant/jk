...
public final class HelpRenderer {
    ...
    public static void printShortHelp(
        ...
        Map<String, dev.jkbuild.model.command.CliCommand> byName = new java.util.LinkedHashMap<>();
        for (dev.jkbuild.model.command.CliCommand c : commands) {
        ...
        for (CommandGroup group : UsageGroups.SHORT_COMMAND_GROUPS) {
            ...
            for (String n : group.names()) {
                dev.jkbuild.model.command.CliCommand sub = byName.get(n);
