 ...
 * ({@code ~/.jk/state/builds/journal/}). The journal is owned by the engine; these verbs are thin
...
public final class HistoryCommand extends GroupCommand {
    ...
    public static final class HistoryShowCommand implements CliCommand {
        ...
        public int run(Invocation in) throws Exception {
            ...
            printRows(lines, EngineProtocol.HISTORY_PHASE, "Phases", p -> "  "
