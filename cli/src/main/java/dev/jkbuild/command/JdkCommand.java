...
public final class JdkCommand implements CliCommand {
    ...
    public List<CliCommand> subcommands() {
        return List.of(new JdkListCommand(), new JdkInstallCommand(), new JdkEnsureCommand(), new JdkUpdateCommand(), new JdkPinCommand(), new JdkDefaultCommand(), new JdkGraalCommand(), new JdkHomeCommand(), new JdkUninstallCommand(), new JdkUpdateShellCommand());
    }
