 ...
 * {@code jk.lock}) → otherwise print the standard {@code jk <command>: no jk.toml in <dir>} error and
 * exit {@link Exit#CONFIG}" preamble that leaf commands (compile/test/explain/tree/lock/…) each spelled
