...
public final class AggregateModuleListener implements PipelineListener {
     ...
     * cc.jumpkick.run.Pipeline#estimatedTotalWeight()} that was summed into the aggregate denominator.
     ...
     * {@link cc.jumpkick.run.StepContext#reweight reweight} mid-run (e.g. a compile that turns out
