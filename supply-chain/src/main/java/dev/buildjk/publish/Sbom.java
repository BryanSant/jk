 ...
 * (PRD §21.2, §23.9).
 *
 * <p>The component graph comes from a project's {@link BuildJk} for the
...
public final class Sbom {
    ...
    public static byte[] cyclonedx(BuildJk project, Lockfile lock) {
    ...
    public static byte[] spdx(BuildJk project, Lockfile lock) {
