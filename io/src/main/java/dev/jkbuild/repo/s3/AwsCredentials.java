...
/**
 * AWS credentials + region for signing S3 (and S3-compatible) requests.
 * {@code sessionToken} is null for long-lived keys, set for STS/temporary
 * credentials (and then sent as {@code x-amz-security-token}). {@code region}
