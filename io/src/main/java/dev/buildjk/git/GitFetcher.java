...
/**
 * JGit-backed git resolver (PRD §11). Layout (PRD §11.5):
 *
 * <pre>
 *   ~/.jk/git/db/&lt;sha256(canonical-url)&gt;/   # bare clone per URL
 *   ~/.jk/git/co/&lt;sha256(canonical-url)&gt;/&lt;sha&gt;/   # checkout per resolved SHA
 * </pre>
 *
