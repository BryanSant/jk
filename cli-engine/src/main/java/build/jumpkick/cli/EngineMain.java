 ...
 * build.jumpkick.cli.EngineMain}. Its
 * whole {@code main()} IS the engine-server loop: no command routing, no {@code --engine-server}
...
public final class EngineMain {
    ...
    static int runJob() {
        try {
            build.jumpkick.engine.EngineServer server = new build.jumpkick.engine.EngineServer(
                    build.jumpkick.engine.EnginePaths.current(),
                    build.jumpkick.config.JkEngineConfig.resolve(),
                    null,
                    Jk.VERSION,
                    System.err::println);
            server.serveJob(
    ...
    public static int run() {
        ...
        build.jumpkick.cli.engine.PosixDetach.intoOwnSession();
        org.jline.utils.Signals.register("INT", () -> {});
        org.jline.utils.Signals.register("HUP", () -> {});
        try {
            build.jumpkick.engine.EnginePaths.Paths paths = build.jumpkick.engine.EnginePaths.current();
            build.jumpkick.config.JkEngineConfig config = build.jumpkick.config.JkEngineConfig.resolve();
            build.jumpkick.config.JkHttpConfig httpConfig =
                    build.jumpkick.config.JkHttpConfig.resolve().orElse(null);
            build.jumpkick.engine.EngineServer server = new build.jumpkick.engine.EngineServer(
    ...
    static int runAotTraining() {
        ...
        try {
            ...
            build.jumpkick.engine.EnginePaths.Paths paths = build.jumpkick.engine.EnginePaths.resolve(tmp);
            build.jumpkick.engine.EngineServer server = new build.jumpkick.engine.EngineServer(
                    paths, build.jumpkick.config.JkEngineConfig.resolve(), null, Jk.VERSION, System.err::println);
            ...
            java.nio.file.Path endpoint = build.jumpkick.engine.EnginePaths.endpoint(paths);
