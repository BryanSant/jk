 ...
 *   <li>Contains {@code :} → {@link Gav} (the {@link dev.jkbuild.model.ToolCoordSpec} grammar;
...
public sealed interface ToolTarget {
    ...
    /** An existing directory (jk project / JBang folder — phase 2). */
    ...
    /** A JBang {@code alias@catalog} reference (phase 4). */
