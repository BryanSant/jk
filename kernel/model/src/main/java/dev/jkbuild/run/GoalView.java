...
/**
 * Read-only snapshot of a {@link Goal}'s state at a single moment. Passed to listeners on every
 * event so they can render without re-querying the goal.
 *
 * <p>Both {@code numerator} and {@code denominator} can grow over time ({@code updateScope} grows
