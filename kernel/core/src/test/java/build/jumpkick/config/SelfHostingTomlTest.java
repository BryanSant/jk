...
class SelfHostingTomlTest {
    ...
    void root_jk_toml_declares_the_workspace() throws Exception {
        ...
        assertThat(root.project().group()).isEqualTo("build.jumpkick");
    ...
    void every_workspace_module_has_a_parseable_jk_toml() throws Exception {
        ...
        for (String module : root.workspace().modules()) {
            ...
            assertThat(parsed.project().group()).isEqualTo("build.jumpkick");
    ...
    void cli_module_declares_a_main_class_and_image_main_class() throws Exception {
        ...
        assertThat(cli.mainClass()).isEqualTo("build.jumpkick.cli.Jk");
        ...
        assertThat(mainModules).contains("build.jumpkick:jk-core", "build.jumpkick:jk-engine-api");
        assertThat(mainModules)
                .doesNotContain("build.jumpkick:jk-engine", "build.jumpkick:jk-io", "build.jumpkick:jk-resolver",
                        "build.jumpkick:jk-toolchain");
        ...
        assertThat(cliEngineMain).contains("build.jumpkick:jk-cli", "build.jumpkick:jk-engine");
