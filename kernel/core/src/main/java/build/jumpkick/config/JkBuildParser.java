...
import build.jumpkick.model.Workspace.WorkspaceDependency;
...
public final class JkBuildParser {
    ...
    /**
     * {@code [[kotlin-plugins]]} — project-declared Kotlin compiler plugins (android-plan Step 5:
