...
public final class EngineProtocol {
     ...
     * build.jumpkick.run.PipelineListener} event type {@link #BUILD_REQUEST} already defined — a test run
     ...
     * build.jumpkick.runtime.BuildPipelines#BUILD_OUTCOME}) client-side rendering needs.
     */
     ...
     * {@code dir}-tagged {@link build.jumpkick.run.PipelineListener} event vocabulary ending in a {@link
    ...
    // pipeline the in-process test path uses (build.jumpkick.runtime.*Pipelines), forks the worker JVM itself
