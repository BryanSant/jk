 ...
 * cc.jumpkick.config.Session} (installed by the CLI composition root) and read here via {@link
...
public final class JvmOptions {
     ...
     *
     * <p>Unlike JVM tuning (now request-scoped on {@link cc.jumpkick.config.Session}), the heap plan
