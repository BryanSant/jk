...
import build.jumpkick.task.AccessLedger;
...
public final class AutoLock {
     ...
     *       constraint. If any dep is missing or out of range, return {@code true} so the build pipeline
    ...
    public static Lockfile maybeReLock(
        ...
        try {
            ...
            build.jumpkick.repo.RepoGroup repos = RepoGroupBuilder.buildFor(effective, repoUrl, cas);
            ...
            build.jumpkick.runtime.GitSourceResolution.Prepared prep;
            try {
            ...
            return updated;
        } catch (build.jumpkick.resolver.pubgrub.UnsatisfiableException e) {
