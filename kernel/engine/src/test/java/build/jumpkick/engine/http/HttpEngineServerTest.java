...
class HttpEngineServerTest {
    ...
    private final java.util.List<build.jumpkick.runtime.BuildMetrics.Entry> metricsRows = new java.util.ArrayList<>();
    ...
    private build.jumpkick.engine.journal.BuildJournal testJournal() {
        return new build.jumpkick.engine.journal.BuildJournal(stateDir.resolve("builds").resolve("journal"));
    }
    ...
    void api_metrics_reports_aggregate_rows_without_a_token_on_loopback() throws Exception {
        var ok = new build.jumpkick.runtime.BuildMetrics.Stats(3, 6000, 1000, 3000);
        var empty = build.jumpkick.runtime.BuildMetrics.Stats.EMPTY;
        metricsRows.add(new build.jumpkick.runtime.BuildMetrics.Entry("build", "", null, null, ok, empty, empty, 5L));
        metricsRows.add(new build.jumpkick.runtime.BuildMetrics.Entry("build", "/p", "g:n", null, ok, empty, empty, 5L));
        metricsRows.add(new build.jumpkick.runtime.BuildMetrics.Entry(
