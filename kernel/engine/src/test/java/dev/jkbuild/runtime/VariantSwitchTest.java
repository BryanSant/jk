...
class VariantSwitchTest {
    ...
    void switching_variants_drops_the_previous_values_extra_src_classes(@TempDir Path tmp) throws Exception {
        ...
        GoalResult a = buildVariant(project, cache, "mode=a");
        ...
        GoalResult b = buildVariant(project, cache, "mode=b");
        ...
        GoalResult a2 = buildVariant(project, cache, "mode=a");
        ...
        dev.jkbuild.util.PathUtil.deleteRecursively(project.resolve("target"));
        GoalResult a3 = buildVariant(project, cache, "mode=a");
        assertThat(a3.success()).as("variant a restores after clean").isTrue();
        assertThat(classes.resolve("OnlyA.class")).exists();
        GoalResult b2 = buildVariant(project, cache, "mode=b");
    ...
    private static GoalResult buildVariant(Path project, Path cache, String selection) {
