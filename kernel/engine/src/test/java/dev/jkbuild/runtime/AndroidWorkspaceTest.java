...
/**
 * android-plan Phase 2 acceptance ("real app shape"): a two-module workspace — an {@code
...
class AndroidWorkspaceTest {
    ...
    void library_module_aar_and_non_transitive_r(@TempDir Path tmp) throws Exception {
        ...
        GoalResult libResult = build(lib, cache);
        ...
        GoalResult appResult = build(app, cache);
    ...
    private static GoalResult build(Path module, Path cache) throws Exception {
