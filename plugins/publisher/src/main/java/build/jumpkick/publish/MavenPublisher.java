...
import build.jumpkick.repo.RepoTransports;
...
public final class MavenPublisher {
    ...
    public MavenPublisher(URI repoBase, RepoCredential credential) {
        this(repoBase, credential, build.jumpkick.model.ObjectStoreConfig.EMPTY);
    }
    ...
    public static MavenPublisher withObjectStore(
            URI repoBase, RepoCredential credential, build.jumpkick.model.ObjectStoreConfig objectStore) {
        return new MavenPublisher(repoBase, credential, objectStore);
    }

    private MavenPublisher(URI repoBase, RepoCredential credential, build.jumpkick.model.ObjectStoreConfig objectStore) {
